import { createDom, deepCopy, addClass, removeClass } from 'xgplayer/src/utils/util'
...
let s_danmu = function () {
  ...
  player.once('complete', () => {
    ...
    transparencyGradient.style.background =
      'linear-gradient(to right, #f85959 0%, #f85959 ' + transparencyValue + '%, #aaa ' + transparencyValue + '%, #aaa)'
